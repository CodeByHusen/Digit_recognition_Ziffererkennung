...
#include "parallel.h"
 ...
 parallel::parallel(int N_Layers, int N_Inputs, int N_Hiddens, int N_Outputs) : Network(N_Layers,  N_Inputs,  N_Hiddens,  N_Outputs) {}

 void parallel::learn(float learn_Rate, int batch_Size) {
